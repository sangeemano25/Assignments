...
public class Assignment1_DataTypes {
	...
	public static void main(String[] args) {
		...
		double customerAccount = 1000.50;
		...
		double latitudeLoc = 37.7749;
		double longitudeLoc = -122.4194;
		...
		float distanceOfCities = 200.5f;
		System.out.println(".Distance between two cities:"+distanceOfCities);
